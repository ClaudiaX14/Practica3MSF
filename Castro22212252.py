"""
Práctica 3: Sistema Musuloesqueletico
...
fg1 = plt.figure()
plt.plot(t,Fs1,'-',linewidth=1,color=np.array([255, 230.01, 230.01])/255,label= 'Fs(1): Control')
plt.plot(t,Fs2,'-',linewidth=1,color=np.array([224.91, 174.93, 209.1])/255,label= 'Fs(2): Caso')
plt.plot(t,u1,'-',linewidth=1,color=np.array([144.84, 172.89, 199.92])/255,label= 'Fs(t): Entrada')
plt.grid(False)
...
plt.plot(t,Fs1,'-',linewidth=1,color=np.array([255, 230.01, 230.01])/255,label= 'Fs(1): Control')
plt.plot(t,Fs2,'-',linewidth=1,color=np.array([224.91, 174.93, 209.1])/255,label= 'Fs(2): Caso')
plt.plot(t,Fs3,'--',linewidth=1,color=np.array([144.84, 172.89, 199.92])/255,label= 'Fs(3): Tratamiento')
plt.plot(t,u1,'-',linewidth=1,color=np.array([116.025,105.06,182.07])/255,label= 'Fs(t): Entrada')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.1,1.1);plt.yticks(np.arange(-0.1,1.1,0.2))
plt.ylabel('t[s]')
